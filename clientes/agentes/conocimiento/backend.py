...
`conocimiento_clientes` (migraciones 004 y 008, aplicadas).

Ya NO lleva filtro por multiagente. La tabla ES la de clientes: la frontera
...
async def similares(vector: list[float], k: int = 5) -> list[dict]:
    """Top-k de `conocimiento_clientes`. [{proceso, descripcion, procedimiento, similitud}]
