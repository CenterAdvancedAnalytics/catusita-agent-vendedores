...
from vendedores.plataforma_vendedores.nodos.contexto import nodo_contexto
from vendedores.plataforma_vendedores.nodos.validar import nodo_validar, MAX_REINTENTOS
from vendedores import registro
from vendedores.orquestador import nodo_orquestador
...
if _fallos := verificar_topologia(grafo):
    raise RuntimeError("grafo de vendedores mal armado: " + " | ".join(_fallos))
