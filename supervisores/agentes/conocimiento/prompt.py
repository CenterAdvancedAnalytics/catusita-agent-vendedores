...
Ese proceso dice que no se entrega. Pasarlo tal cual hace que el asesor reciba
...
Al orquestador, que es otro agente — nunca al asesor. Él tiene la conversación
...
Tampoco redactes para el asesor ni le des consejos («contactá a la sucursal»,
«revisá tu CRM»). Devolvés el procedimiento; qué se le dice al asesor lo decide
el orquestador.
